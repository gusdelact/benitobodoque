...
Begin
      ...
      Try
        ...
        QrTasaActB.QRInterEncabezado1.Titulo1:='Reporte Pronóstico de Adeudo ' + sCesion;
        If Trim(sFechaIni)<>'' Then
           QrTasaActB.QRInterEncabezado1.Titulo2:='Pronóstico al ' + Trim(sFechaIni)
        Else
           QrTasaActB.QRInterEncabezado1.Titulo2:='Pronóstico al ' + DateToStr(pAPli.DameFechaEmpresa);
