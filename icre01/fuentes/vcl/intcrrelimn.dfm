object WCrRelLiqMn: TWCrRelLiqMn
  Left = 236
  Top = 160
  Width = 527
  Height = 228
  Caption = 'Relación Medio de Liquidación - Moneda'
  Color = clBtnFace
  ...
  object lbCVE_LIQ_CHQRA: TLabel
    Left = 8
    Top = 98
    Width = 126
    Height = 13
    Caption = 'Chequera Correspondiente'
    Visible = False
  end
  ...
  object rgCVE_LIQ_CHQRA: TRadioGroup
    Tag = 50
    Left = 8
    Top = 82
    Width = 505
  ...
  object ilLIQUIDA: TInterLinkit
    Control = edCVE_LIQUIDACION
    OnEjecuta = ilLIQUIDAEjecuta
    TipoReader = trTexto
    CharCase = ecUpperCase
    OnCapture = ilLIQUIDACapture
    Left = 232
    Top = 8
  end
