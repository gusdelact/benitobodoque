object WCrAutClin: TWCrAutClin
  Left = 222
  Top = 83
  Width = 716
  Height = 342
  Caption = 'Relación autorización - disposición marco'
  Color = clBtnFace
  ...
  object ilID_CREDITO_MARCO: TInterLinkit
    Control = edID_CREDITO_MARCO
    OnEjecuta = ilID_CREDITO_MARCOEjecuta
    TipoReader = trContrato
    CharCase = ecNormal
    OnCapture = ilID_CREDITO_MARCOCapture
    Left = 227
    Top = 34
  end
end
