object WCrCierCo: TWCrCierCo
  Left = 405
  Top = 145
  Width = 797
  Height = 628
  Caption = 'Cierre Coincre'
  Color = clBtnFace
  ...
  object Label2: TLabel
    ...
    Height = 13
    Caption = 
      'NOTA: La imágen en movimiento representa la ejecución del proces' +
      'o...'
  end
  ...
  object bbApertura: TBitBtn
    ...
    Width = 214
    Height = 30
    Caption = 'Inicia Proceso de Cierre COINCRE'
    TabOrder = 0
    TabStop = False
