object WCrCancPas: TWCrCancPas
  Left = 200
  Top = 28
  Width = 1001
  Height = 788
  Caption = 'Módulo de Cancelacion de Pasivos'
  Color = clBtnFace
  ...
  object lbLiqF_INICIO: TLabel
    ...
    Width = 76
    Height = 13
    Caption = 'F. de Aplicacion'
  end
  object GBreversa: TGroupBox
    Left = 8
    Top = 176
    Width = 977
    Height = 105
    Caption = 'Carga de Vencimientos Anticipados Procesados en el MES'
    TabOrder = 7
    Visible = False
    object BnMostrar: TBitBtn
      Left = 16
      Top = 40
      Width = 153
      Height = 25
  ...
  object GBVenc: TGroupBox
    ...
    Width = 977
    Height = 105
    Caption = 'Carga Masiva de Creditos para Cancelacion Pasiva'
    TabOrder = 2
  ...
  object GBAutorizacion: TGroupBox
    ...
    object strgrdCanc: TStringGrid
      ...
      TabOrder = 0
      OnDrawCell = strgrdCancDrawCell
      OnMouseDown = strgrdCancMouseDown
    end
  end
  ...
  object Ropcion: TRadioGroup
    ...
    Items.Strings = (
      ...
      'Reversa de Cancelacion de Pasivo')
    TabOrder = 6
    OnClick = RopcionClick
  end
  object Lcreditos: TListBox
    Left = 16
    Top = 544
    Width = 33
    Height = 17
  ...
  object edF_Aplicacion: TEdit
    ...
    ReadOnly = True
    TabOrder = 21
    OnChange = edF_AplicacionChange
  end
  object CBdevpasivo: TCheckBox
    Left = 144
    Top = 552
    Width = 281
    Height = 17
    Caption = 'Cancelación por Rescate (Cancela FEGAS y Pasivo)'
    TabOrder = 22
    OnClick = CBdevpasivoClick
  end
  object dtpF_RECUPERACION: TDateTimePicker
    Left = 433
    Top = 551
    Width = 96
    Height = 22
  ...
  object BRedesctoCERO: TBitBtn
    Tag = 17
    Left = 816
    Top = 551
    Width = 161
    Height = 22
    Caption = 'Canc. Redescto en CERO'
    Enabled = False
    TabOrder = 24
    OnClick = BRedesctoCEROClick
    Glyph.Data = {
      76010000424D7601000000000000760000002800000020000000100000000100
      04000000000000010000120B0000120B00001000000000000000000000000000
      800000800000008080008000000080008000808000007F7F7F00BFBFBF000000
