object wMPrgApoyo: TwMPrgApoyo
  ...
  Width = 545
  Height = 500
  Caption = 'Catálogo de Programas de Apoyo'
  Color = clBtnFace
  ...
  object ch_B_PROV_GARANTIA: TCheckBox
    ...
    Height = 17
    HelpContext = 5000
    Caption = 'Genera Provisión de Garantía'
    TabOrder = 6
  ...
  object GB_Conf_TasaComb: TGroupBox
    ...
    Width = 513
    Height = 235
    Caption = 'Configuración Días Tasa x Periodo'
    TabOrder = 9
    TabStop = True
  ...
  object ch_B_CFG_DIAS_TASA: TCheckBox
    ...
    Height = 17
    HelpContext = 6000
    Caption = 'Configuración de cálculo de interés especial (días anteriores)'
    TabOrder = 7
