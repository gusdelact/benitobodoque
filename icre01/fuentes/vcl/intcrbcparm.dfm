object WCrBCParm: TWCrBCParm
  Left = 338
  Top = 310
  Width = 575
  Height = 217
  Caption = 'Catálogo de Parametros de calculo para buro'
  Color = clBtnFace
  ...
  object edCVE_PARAMETRO: TEdit
    ...
    ReadOnly = True
    TabOrder = 2
    OnExit = edCVE_PARAMETROExit
  end
  object edVALOR_PARAMETRO: TEdit
    Tag = 18
    Left = 99
    Top = 78
    Width = 160
