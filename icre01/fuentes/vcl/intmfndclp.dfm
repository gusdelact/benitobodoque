object wMFndCLP: TwMFndCLP
  Left = 290
  Top = 216
  Width = 548
  Height = 505
  Caption = 'Reporte de Pasivo Corto y Largo Plazo'
  Color = clBtnFace
  ...
  object cbxCVE_FND_ENT_DES: TCheckBox
    Left = 503
    Top = 36
    Width = 14
    Height = 15
    ...
    Enabled = False
    TabOrder = 3
    OnClick = cbxCVE_FND_ENT_DESClick
  end
  object rgGenerarArchivo: TRadioGroup
    Left = 0
    Top = 116
    Width = 532
    Height = 36
