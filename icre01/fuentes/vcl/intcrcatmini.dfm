object WCrCatMinimo: TWCrCatMinimo
  ...
  Width = 820
  Height = 430
  Caption = 'Catálogo de Clasificación Contable'
  Color = clBtnFace
  ...
  object pgAltaDatos: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object Label8: TLabel
        ...
        Width = 138
        Height = 13
        Caption = 'Clave Operación Facturación'
      end
      ...
      object edCVE_CAT_MIN_VEN: TEdit
        ...
        Width = 388
        Height = 21
        Hint = 'Introduzca la descripción del tipo de acreditado'
        HelpContext = 2001
        CharCase = ecUpperCase
        MaxLength = 20
        ParentShowHint = False
      ...
      object rgCVE_CLASIF_DEST: TRadioGroup
        ...
        Height = 41
        HelpContext = 4001
        Caption = 'Clave de Clasificación de Destino'
        Columns = 2
        ItemIndex = 0
        Items.Strings = (
          'Banco'
      ...
      object rgSIT_CAT_MINIMO: TRadioGroup
        ...
        Height = 41
        HelpContext = 8000
        Caption = 'Situación de Catálogo Mínimo'
        Columns = 2
        ItemIndex = 0
        Items.Strings = (
          'Activo'
    ...
    object TabSheet2: TTabSheet
      ...
      object Label5: TLabel
        ...
        Width = 406
        Height = 14
        Caption = 'Claves Clasificación destino: Banco (BC), Fideicomiso (FI)'
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Courier New'
