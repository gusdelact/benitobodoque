object WCrProdSecCont: TWCrProdSecCont
  Left = 293
  Top = 166
  Width = 653
  Height = 302
  Caption = 'Relación Producto - Sector Contable'
  Color = clBtnFace
  ...
  object edDESC_L_PROD_CRE: TEdit
    Left = 204
    Top = 14
    Width = 410
    Height = 21
  ...
  object cbCVE_SECTOR_CONTAB: TComboBox
    Tag = 50
    Left = 104
    Top = 46
    Width = 73
    ...
    ItemHeight = 13
    TabOrder = 2
    OnExit = cbCVE_SECTOR_CONTABExit
  end
