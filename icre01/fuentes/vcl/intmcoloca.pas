...
constructor TMColoca.Create( AOwner : TComponent );
begin Inherited;
...
//      PromotorAdmon.BuscaWhereString := 'SIT_EMPLEADO = ''AC''';
      ...
      UseQuery := False;
      HelpFile := 'InTMColoca.Hlp';
      ShowMenuReporte:=True;
end;

Destructor TMColoca.Destroy;
begin
...
function TMColoca.ShowWindow(FormaTipo:TFormaTipo):Integer;
var W : TwMColoca;
begin
   W:=TwMColoca.Create(Self);
   try
      W.Objeto:= Self;
...
Function TMColoca.InternalBusca:Boolean;
...
(*                                                                              *)
(***********************************************FORMA NINGUNO********************)
procedure TwMColoca.AsignaEmpresaSuc;
begin
...
procedure TwMColoca.FormShow(Sender: TObject);
begin
...
procedure TwMColoca.FormDestroy(Sender: TObject);
begin
...
procedure TwMColoca.FormClose(Sender: TObject; var Action: TCloseAction);
begin Action := caFree;
end;

procedure TwMColoca.InterForma1DespuesNuevo(Sender: TObject);
begin //<<Control>>.SetFocus;
end;

procedure TwMColoca.InterForma1DespuesModificar(Sender: TObject);
begin //<<Control>>.SetFocus;
end;
...
procedure TwMColoca.btCVE_MONEDAClick(Sender: TObject);
begin
...
procedure TwMColoca.ilMONEDACapture(Sender: TObject; var Show: Boolean);
begin
   Show := True;
end;

procedure TwMColoca.ilMONEDAEjecuta(Sender: TObject);
begin
...
procedure TwMColoca.edCVE_MONEDAExit(Sender: TObject);
begin
    InterForma1.ValidaExit(edCVE_MONEDA,True,'',True);
end;

procedure TwMColoca.btPROMOTORClick(Sender: TObject);
begin
...
procedure TwMColoca.ilPROMOTORCapture(Sender: TObject;
  var Show: Boolean);
begin
   Show:=True;
end;

procedure TwMColoca.ilPROMOTOREjecuta(Sender: TObject);
begin
...
procedure TwMColoca.edID_PROMOTORExit(Sender: TObject);
begin
      InterForma1.ValidaExit(edID_PROMOTOR,True,'',True);
end;

procedure TwMColoca.chbxMonedaClick(Sender: TObject);
begin
...
procedure TwMColoca.chbxPromotorClick(Sender: TObject);
begin
...
procedure TwMColoca.InterForma1BtnPreviewClick(Sender: TObject);
begin
   if Objeto.ValidaAccesoEsp('TMCOLOCA_PREVI',True,True) then
    //<LOLS 17ENE2006. DIGITALIZACION DE REPORTES>
...
procedure TwMColoca.ilACREDITADOCapture(Sender: TObject;
  var Show: Boolean);
begin
   Show := True;
end;

procedure TwMColoca.ilACREDITADOEjecuta(Sender: TObject);
begin
...
procedure TwMColoca.btACREDITADOClick(Sender: TObject);
begin
...
procedure TwMColoca.edCVE_PRODUCTO_CREExit(Sender: TObject);
begin
    InterForma1.ValidaExit(edCVE_PRODUCTO_CRE,True,'',True);
end;

procedure TwMColoca.btPRODUCTOClick(Sender: TObject);
begin
...
procedure TwMColoca.ilPRODUCTOCapture(Sender: TObject;
  var Show: Boolean);
begin
   Show := True;
end;

procedure TwMColoca.ilPRODUCTOEjecuta(Sender: TObject);
begin
...
procedure TwMColoca.chbxProductoClick(Sender: TObject);
begin
...
procedure TwMColoca.chbxAcreditadoClick(Sender: TObject);
begin
...
procedure TwMColoca.edACREDITADOExit(Sender: TObject);
begin
      InterForma1.ValidaExit(edACREDITADO,True,'',True);
end;

procedure TwMColoca.btPROM_ADMONClick(Sender: TObject);
begin
...
procedure TwMColoca.ilPromAdmonCapture(Sender: TObject; var Show: Boolean);
begin
   Show:=True;
end;

procedure TwMColoca.ilPromAdmonEjecuta(Sender: TObject);
begin
...
procedure TwMColoca.edID_PROMExit(Sender: TObject);
begin
      InterForma1.ValidaExit(edID_PROM,True,'',True);
end;

procedure TwMColoca.chbxPromAmonClick(Sender: TObject);
begin
...
procedure TwMColoca.edID_PROMOTORChange(Sender: TObject);
begin
...
procedure TwMColoca.edID_PROMChange(Sender: TObject);
begin
...
//<LOLS 17ENE2006. DIGITALIZACION DE REPORTES>
Procedure TwMColoca.ImprimeReporte(bPreview:Boolean; grOpcion  : TGenRepOption );
//Procedure TwMColoca.ImprimeReporte(bPreview:Boolean);
//</LOLS>
Var
...
begin
    ...
    End;
End;
procedure TwMColoca.InterForma1BtnImprimirClick(Sender: TObject);
begin
   if Objeto.ValidaAccesoEsp('TMCOLOCA_IMPRI',True,True) then
    //<LOLS 17ENE2006. DIGITALIZACION DE REPORTES>
...
procedure TwMColoca.edID_CESIONChange(Sender: TObject);
begin
...
procedure TwMColoca.edID_CESIONExit(Sender: TObject);
begin
    InterForma1.ValidaExit(edID_CESION,True,'',True);
end;

procedure TwMColoca.btID_CESIONClick(Sender: TObject);
begin
...
procedure TwMColoca.chbxCESIONClick(Sender: TObject);
begin
...
procedure TwMColoca.ilCesionCapture(Sender: TObject;
  var Show: Boolean);
begin
   Show:=True;
end;

procedure TwMColoca.ilCesionEjecuta(Sender: TObject);
begin
...
procedure TwMColoca.sbExcelClick(Sender: TObject);
var sExt:String;
begin
...
procedure TwMColoca.cbxArchivoClick(Sender: TObject);
begin
...
procedure TwMColoca.edNbrArchChange(Sender: TObject);
begin
    If Trim(edNbrArch.Text)<>'' Then Begin
        cbxArchivo.Checked:=True;
        cbxArchivo.Enabled:=True;
...
procedure TwMColoca.cbxCVE_PRODUCTO_GPOClick(Sender: TObject);
begin
...
procedure TwMColoca.btCVE_PRODUCTO_GPOClick(Sender: TObject);
begin
...
procedure TwMColoca.ilCVE_PRODUCTO_GPOCapture(Sender: TObject;
  var Show: Boolean);
begin
   Show:=True;
end;

procedure TwMColoca.ilCVE_PRODUCTO_GPOEjecuta(Sender: TObject);
begin
...
Procedure TwMColoca.CambiaControl;
Begin
   ...
   cbxCVE_PRODUCTO_GPO.Enabled:=True;
End;
procedure TwMColoca.edCVE_PRODUCTO_GPOExit(Sender: TObject);
begin
    InterForma1.ValidaExit(edCVE_PRODUCTO_GPO,True,'',True);
end;

procedure TwMColoca.bbEmpresaClick(Sender: TObject);
begin
   Objeto.Empresa.ShowAll := True;
   Objeto.Empresa.Busca;
end;

procedure TwMColoca.BBSucursalClick(Sender: TObject);
begin
...
procedure TwMColoca.ilEmpresaEjecuta(Sender: TObject);
begin
   Objeto.Empresa.FindKey([ilEmpresa.Buffer])
end;

procedure TwMColoca.ILSucursalEjecuta(Sender: TObject);
begin
...
procedure TwMColoca.CBSucursalClick(Sender: TObject);
begin
...
procedure TwMColoca.edCVE_MEDIOExit(Sender: TObject);
begin
    InterForma1.ValidaExit(edCVE_MEDIO,True,'',True);
end;

// </ICASE JMML 28/Septiembre/2006>   Nuevo procedimiento
procedure TwMColoca.btCVE_MEDIOClick(Sender: TObject);
begin
...
// </ICASE JMML 28/Septiembre/2006>   Nuevo procedimiento
procedure TwMColoca.ilMEDIOCapture(Sender: TObject; var Show: Boolean);
begin
   Show := True;
end;

// </ICASE JMML 28/Septiembre/2006>   Nuevo procedimiento
procedure TwMColoca.ilMEDIOEjecuta(Sender: TObject);
begin
...
// </ICASE JMML 28/Septiembre/2006>   Nuevo procedimiento
procedure TwMColoca.chbxMedioClick(Sender: TObject);
begin
