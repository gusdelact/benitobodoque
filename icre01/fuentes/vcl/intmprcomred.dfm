object wMPrComRed: TwMPrComRed
  Left = 192
  Top = 108
  Width = 583
  Height = 393
  Caption = 'Programación de Comisiones de Redescuento de Disposiciones'
  Color = clBtnFace
  ...
  object rgCVE_TIPO_APLICA: TRadioGroup
    Tag = 18
    Left = 0
    Top = 91
    Width = 575
    ...
    ItemIndex = 0
    Items.Strings = (
      'Por Periodo de Capital'
      'Mensual'
      'Anual')
    TabOrder = 12
    OnEnter = rgCVE_TIPO_APLICAEnter
    OnExit = rgCVE_TIPO_APLICAExit
  end
  ...
  object cbxB_GEN_COM_DISP: TCheckBox
    Tag = 18
    Left = 0
    Top = 140
    Width = 185
    ...
    Caption = 'Registra comisión en disposición'
    TabOrder = 13
    OnExit = cbxB_GEN_COM_DISPExit
  end
