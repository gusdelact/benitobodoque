object wMRepGlbCr: TwMRepGlbCr
  Left = 280
  Top = 199
  Width = 563
  Height = 359
  Caption = 'Reporte de Garantías Global de Créditos al Sector Agropecuario'
  Color = clBtnFace
  ...
  object cbxACREDITADO: TCheckBox
    Left = 516
    Top = 63
    Width = 15
    Height = 17
  ...
  object rgFechas: TGroupBox
    ...
    Width = 536
    Height = 42
    Caption = 'Rango de Fechas de Inicio de la Disposición'
    TabOrder = 13
    ...
    object stpFin: TInterDateTimePicker
      ...
      Height = 21
      CalAlignment = dtaLeft
      Date = 38196.3922179514
      Time = 38196.3922179514
      DateFormat = dfShort
      DateMode = dmComboBox
      Kind = dtkDate
      ParseInput = False
  ...
  object rgSIT_CREDITO: TRadioGroup
    Tag = 512
    Left = 5
    Top = 104
    Width = 537
