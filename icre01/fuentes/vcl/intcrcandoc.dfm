object WCrcandoc: TWCrcandoc
  Left = 291
  Top = 87
  Width = 649
  Height = 432
  Caption = 'Búsqueda  en Bloque de Documentos'
  Color = clBtnFace
  ...
  object cbB_APLI_DOCTO: TCheckBox
    Left = 592
    Top = 36
    Width = 17
    Height = 17
  ...
  object ilDOCTO: TInterLinkit
    Control = edID_DOCUMENTO
    OnEjecuta = ilDOCTOEjecuta
    TipoReader = trTexto
    CharCase = ecUpperCase
    Left = 224
    Top = 32
