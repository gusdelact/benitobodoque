...
type
  TQrCompCOINCREDetalleS = class(TQuickRep)
    QRBand1: TQRBand;
  ...
  public
       Apli : TInterApli;
//       Function ArmaQuery_CONSOLIDADO_Detalle(PEMes,PEAnio : Integer; PETipoCar : String; PETipoRep : String;Detalle :Boolean): String; //RABA JUL 2015 YA NO SE USA
//       Function ArmaQuery_COINCRE_Detalle(PEMes,PEAnio : Integer; PETipoCar : String; PETipoRep : String;Detalle :Boolean): String;     //RABA JUL 2015 YA NO SE USA
...
var
  QrCompCOINCREDetalle: TQrCompCOINCREDetalleS;

Procedure RepCompCOINCREDetalleS(PEMes,PEAnio : Integer;
                                 PEMesTxt : String;
                                 pAPli     : TInterApli;
                                 pPreview  : Boolean;
                                 PETipoRep : String;
...
Var
   ...
   vlFecha     : TDateTime;
begin
   QrCompCOINCREDetalle := TQrCompCOINCREDetalleS.Create(Nil);
   ...
   Try
      ...
      QrCompCOINCREDetalle.QRInterEncabezado1.NomReporte:='IntQrCoCS';
      ...
      if PETipoRep = 'ME' then
         Begin
         QrCompCOINCREDetalle.QRInterEncabezado1.Titulo1 := 'COINCRE - CONTA DOS ' + '(MENSUAL)';
      ...
      if PETipoRep = 'DI' then
         Begin
         QrCompCOINCREDetalle.QRInterEncabezado1.Titulo1 := 'CONSOLIDADO - CONTA DOS ' + '(DIARIO)';
      ...
      if PETipoRep = 'DM' then
         Begin
         QrCompCOINCREDetalle.QRInterEncabezado1.Titulo1 := 'CONSOLIDADO - CONTA DOS ' + '(DIARIO FIN DE MES)';
         QrCompCOINCREDetalle.QRInterEncabezado1.Titulo2 := 'Periodo: ' +  PEMesTxt +  ' del ' + IntToStr(PEAnio);
         End;
      //end if
...
{Function TQrCompCOINCREDetalleS.ArmaQuery_CONSOLIDADO_Detalle(PEMes,PEAnio : Integer; PETipoCar : String; PETipoRep : String; Detalle : Boolean): String;
var
     VlSalida  : String;
     VLFechaD  : String;
...
Function TQrCompCOINCREDetalleS.ArmaQuery_CONTABLE_SAP(PEMes, PEAnio : Integer;
                                                      pebColocaUnionAll,
                                                      pebMuestraK_VIG,
                                                      pebMuestraK_IMP,
                                                      pebMuestraK_VEN,
...
////      '               FROM   CR_CONT_CVES_GUIA CCCG'+coCRLF+   //ROIM 201304 CAMBIO CATALOGO VIEJO 2013
{      '               FROM   CR_CONT_GUIA_BCK CCCG'+coCRLF+        //ROIM 201304 CAMBIO CATALOGO VIEJO 2013
      '               WHERE  CCCG.CVE_CUENTA = ''SIPAVE'''+coCRLF+
      '                 AND  CCCG.CVE_TIPO_CTA = ''SR'''+coCRLF+   // RABA ENE 2013 CREDITOS SIN RESTRICCION
      '                 AND  CCCG.CVE_PERIODO = ''201304'''+coCRLF+    //ROIM 201304 CAMBIO CATALOGO VIEJO 2013
      '             ) METRICA'+coCRLF+
}
      '             (SELECT DISTINCT SUBSTR(CCCG.CTA_CONTABLE,1,10) AS CVE_CUENTA, SUBSTR(CCCG.CTA_CONTABLE,1,10) AS ID_METRICA '+coCRLF+
      '               FROM   CR_CONT_CTA_GUIA CCCG, '+coCRLF+
      '                      CR_CONT_BIT_CAT BI '+coCRLF+
      '               WHERE CCCG.CVE_PROCESO = BI.CVE_PROCESO '+coCRLF+
...
//FIN RABA
  ...
  If (pebMuestraK_VEN) Then
      ...
      '             ) Z,'+coCRLF+
//RABA JUL 2015 B-6
//      '             ( SELECT DISTINCT SUBSTR(CCCG.CTA_CONTABLE,1,10) AS CVE_CUENTA, SUBSTR(CCCG.CTA_CONTABLE,1,2)||SUBSTR(CCCG.CTA_CONTABLE,5,6) AS ID_METRICA'+coCRLF+
////      '               FROM   CR_CONT_CVES_GUIA CCCG'+coCRLF+   //ROIM 201304 CAMBIO CATALOGO VIEJO 2013
{      '               FROM   CR_CONT_GUIA_BCK CCCG'+coCRLF+   //ROIM 201304 CAMBIO CATALOGO VIEJO 2013
...
Function TQrCompCOINCREDetalleS.ArmaQuery_CONSOLIDADO_Detalle_SAP(PEMes,PEAnio : Integer;
                                                                 PETipoRep : String;
                                                                 pebMuestraK_VIG,
                                                                 pebMuestraK_IMP,
                                                                 pebMuestraK_VEN,
...
}//            '                CR_CONT_CVES_GUIA CCCG'+coCRLF+      //ROIM 201304 CAMBIO CATALOGO VIEJO 2013     4
{            '                CR_CONT_GUIA_BCK CCCG'+coCRLF+      //ROIM 201304 CAMBIO CATALOGO VIEJO 2013
...
{            '       ( SELECT GP.CVE_PROD_PROG AS ID_OLTP_PRODUCTO, SUBSTR(CCCG.CTA_CONTABLE,1,10) AS ID_METRICA'+coCRLF+
            '         FROM   CR_CONT_GPO_PRO GP,'+coCRLF+
}//            '                CR_CONT_CVES_GUIA CCCG'+coCRLF+       //ROIM 201304 CAMBIO CATALOGO VIEJO 2013
{            '                CR_CONT_GUIA_BCK CCCG'+coCRLF+       //ROIM 201304 CAMBIO CATALOGO VIEJO 2013
            '         WHERE  GP.CVE_GPO = CCCG.CVE_GPO'+coCRLF+
            '         AND    CCCG.CVE_TIPO_CTA = ''SR'''+coCRLF+   // RABA ENE 2013 CREDITOS SIN RESTRICCION
	    '	      AND    CCCG.CVE_CUENTA = ''COPAVE'''+coCRLF+
...
Function TQrCompCOINCREDetalleS.ArmaQuery_COINCRE_Detalle_SAP(PEMes,PEAnio : Integer;
                                                             PETipoRep : String;
                                                             pebMuestraK_VIG,
                                                             pebMuestraK_IMP,
                                                             pebMuestraK_VEN,
...
{Function TQrCompCOINCREDetalleS.ArmaQuery_COINCRE_Detalle(PEMes,PEAnio : Integer; PETipoCar : String; PETipoRep : String; Detalle : Boolean): String;
var
     VlSalida  : String;
     VLFechaD  : String;
     vlCredito,vlCredito2,vlCredito3: String;
...
procedure TQrCompCOINCREDetalleS.qrDetalleBeforePrint(Sender: TQRCustomBand;  var PrintBand: Boolean);
begin
...
procedure TQrCompCOINCREDetalleS.qrGrupoMetricaBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
     vgBPintaTotalProd := False;
end;

procedure TQrCompCOINCREDetalleS.qrPiedeGrupoMetricaBeforePrint(Sender: TQRCustomBand;  var PrintBand: Boolean);
begin
     PrintBand := vgBPintaTotalProd;
end;

procedure TQrCompCOINCREDetalleS.IniciaArchivoExcel(peFileName : String);
...
function TQrCompCOINCREDetalleS.Cierra_Y_Guarda_ArchivoExcel : Boolean;
begin
  Result := False;
...
procedure TQrCompCOINCREDetalleS.AgregaSaldosArchivoExcel(peCVE_SECTOR,
                                                  peDESC_SECTOR,
                                                  peID_OLTP_PRODUCTO_or_peCVE_CTA_CONTABLE,
                                                  peDESC_OLTP_PRODUCTO : String;
                                                  peIMP_SDO_COINCRE,
...
procedure TQrCompCOINCREDetalleS.ColocaFormulas;
var vlRange : Variant;
begin
   // Valida si se genera o no el Archivo de Excel
   If (Not vgBGeneraArchivo) Then Exit;
...
procedure TQrCompCOINCREDetalleS.qrGrupoMonedaAfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
   // Valida si se genera o no el Archivo de Excel
   If (Not vgBGeneraArchivo) Then Exit;
...
procedure TQrCompCOINCREDetalleS.qrGrupoTipoCuentaAfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
var vlRange : Variant;
begin
   // Valida si se genera o no el Archivo de Excel
...
procedure TQrCompCOINCREDetalleS.qrGrupoSectorAfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  // Valida si se genera o no el Archivo de Excel
  If (Not vgBGeneraArchivo) Then Exit;
...
procedure TQrCompCOINCREDetalleS.qrDetalleAfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  // Valida si se genera o no el Archivo de Excel
  If (Not vgBGeneraArchivo) Then Exit;
...
procedure TQrCompCOINCREDetalleS.qrPiedeGrupoSectorAfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  // Valida si se genera o no el Archivo de Excel
  If (Not vgBGeneraArchivo) Then Exit;
...
procedure TQrCompCOINCREDetalleS.qrPiedeGrupoMetricaAfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
var vlRange : Variant;
begin
  // Valida si se genera o no el Archivo de Excel
...
procedure TQrCompCOINCREDetalleS.qrGrupoSegmentoAfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
var vlRange : Variant;  
begin
...
procedure TQrCompCOINCREDetalleS.qrPiedeGrupoSegmentoAfterPrint(
