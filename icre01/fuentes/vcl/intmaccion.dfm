object wMAccion: TwMAccion
  Left = 297
  Top = 140
  Width = 529
  Height = 160
  Caption = 'Reporte Integración Accionaria'
  Color = clBtnFace
  ...
  object edID_ACCIONISTA: TEdit
    ...
    MaxLength = 8
    TabOrder = 4
    OnChange = edID_ACCIONISTAChange
    OnExit = edID_ACCIONISTAExit
  end
  object btAccionista: TBitBtn
    Tag = 17
    Left = 158
    Top = 74
    Width = 22
  ...
  object chbxAccionista: TCheckBox
    Left = 480
    Top = 77
    Width = 13
    Height = 17
  ...
  object ilAccionista: TInterLinkit
    Control = edID_ACCIONISTA
    OnEjecuta = ilAccionistaEjecuta
    TipoReader = trTexto
    CharCase = ecUpperCase
    OnCapture = ilAccionistaCapture
    Left = 304
    Top = 71
  end
