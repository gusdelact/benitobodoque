object wMQLiMaxFi: TwMQLiMaxFi
  Left = 267
  Top = 169
  Width = 537
  Height = 195
  Caption = 'Limite Máximo de Financiamiento'
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    Height = 50
    HelpContext = 3000
    Caption = 'Datos ( Temporales ) del Trimestre'
    TabOrder = 4
    ...
    object edCAP_BASICO: TInterEdit
      Left = 91
      Top = 18
      Width = 95
      Height = 21
