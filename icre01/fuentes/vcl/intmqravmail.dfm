object QrAvMail: TQrAvMail
  ...
  object QRBand2: TQRBand
    ...
    object QRLConceptoIVA: TQRLabel
      Left = 10
      Top = 321
      Width = 93
      Height = 17
  ...
  object qyAvMail: TQuery
    ...
    Left = 236
    Top = 32
    object qyAvMailID_CESION: TFloatField
      FieldName = 'ID_CESION'
    end
    object qyAvMailNOM_EMISOR: TStringField
      FieldName = 'NOM_EMISOR'
      Size = 80
    end
    object qyAvMailNOM_PROVEEDOR: TStringField
      FieldName = 'NOM_PROVEEDOR'
      Size = 80
    end
    object qyAvMailRFC_E: TStringField
      FieldName = 'RFC_E'
      Size = 14
    end
    object qyAvMailRFC_P: TStringField
      FieldName = 'RFC_P'
      Size = 14
    end
    object qyAvMailDIRECCION_E: TStringField
      FieldName = 'DIRECCION_E'
      Size = 60
    end
    object qyAvMailCOLONIA_E: TStringField
      FieldName = 'COLONIA_E'
      Size = 40
    end
    object qyAvMailDELEGACION_E: TStringField
      FieldName = 'DELEGACION_E'
      Size = 40
    end
    object qyAvMailCODIGO_POSTAL_E: TStringField
      FieldName = 'CODIGO_POSTAL_E'
      Size = 6
    end
    object qyAvMailCIUDAD_E: TStringField
      FieldName = 'CIUDAD_E'
      Size = 40
    end
    object qyAvMailDIRECCION_P: TStringField
      FieldName = 'DIRECCION_P'
      Size = 60
    end
    object qyAvMailCOLONIA_P: TStringField
      FieldName = 'COLONIA_P'
      Size = 40
    end
    object qyAvMailDELEGACION_P: TStringField
      FieldName = 'DELEGACION_P'
      Size = 40
    end
    object qyAvMailCODIGO_POSTAL_P: TStringField
      FieldName = 'CODIGO_POSTAL_P'
      Size = 6
    end
    object qyAvMailCIUDAD_P: TStringField
      FieldName = 'CIUDAD_P'
      Size = 40
    end
    object qyAvMailDESC_L_PRODUCTO: TStringField
      FieldName = 'DESC_L_PRODUCTO'
      Size = 80
    end
    object qyAvMailCTA_EMI: TStringField
      FieldName = 'CTA_EMI'
      FixedChar = True
      Size = 4
    end
    object qyAvMailCTA_PROV: TStringField
      FieldName = 'CTA_PROV'
      FixedChar = True
      Size = 4
    end
    object qyAvMailDESC_MONEDA: TStringField
      FieldName = 'DESC_MONEDA'
    end
    object qyAvMailIMP_CAPITAL: TFloatField
      FieldName = 'IMP_CAPITAL'
    end
    object qyAvMailIMP_INTERES: TFloatField
      FieldName = 'IMP_INTERES'
    end
    object qyAvMailIMP_IVA: TFloatField
      FieldName = 'IMP_IVA'
    end
    object qyAvMailIMP_TOTAL_INT: TFloatField
      FieldName = 'IMP_TOTAL_INT'
    end
    object qyAvMailAVISO: TStringField
      FieldName = 'AVISO'
      FixedChar = True
      Size = 5
    end
    object qyAvMailF_ALTA: TDateTimeField
      FieldName = 'F_ALTA'
    end
    object qyAvMailCERO: TFloatField
      FieldName = 'CERO'
    end
    object qyAvMailCONCEPTO: TFloatField
      FieldName = 'CONCEPTO'
    end
    object qyAvMailIVA: TFloatField
      FieldName = 'IVA'
    end
    object qyAvMailIMPORTE_TOT: TFloatField
      FieldName = 'IMPORTE_TOT'
    end
    object qyAvMailF_AUTORIZA: TDateTimeField
      FieldName = 'F_AUTORIZA'
    end
    object qyAvMailB_APLICA_IVA: TStringField
      FieldName = 'B_APLICA_IVA'
      Size = 1
    end
    object qyAvMailCVE_PER_JURIDICA: TStringField
      FieldName = 'CVE_PER_JURIDICA'
      Size = 2
    end
    object qyAvMailPCT_IVA: TFloatField
      FieldName = 'PCT_IVA'
    end
  end
