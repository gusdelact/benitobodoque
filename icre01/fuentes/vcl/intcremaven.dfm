object WCremaven: TWCremaven
  Left = 406
  Top = 220
  Width = 514
  Height = 330
  Caption = 'Relación Destinatarios - Emisor (Alertas de Vencimientos)'
  Color = clBtnFace
  ...
  object ilEMISOR: TInterLinkit
    Control = edID_EMISOR
    OnEjecuta = ilEMISOR1Ejecuta
    TipoReader = trTexto
    CharCase = ecUpperCase
    OnCapture = ilEMISOR1Capture
    Left = 256
    Top = 50
  end
end
