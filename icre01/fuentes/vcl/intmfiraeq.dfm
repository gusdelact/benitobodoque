object wMFiraEq: TwMFiraEq
  Left = 318
  Top = 228
  Width = 559
  Height = 270
  Caption = 'Equivalencia de Cobertura Porcentual'
  Color = clBtnFace
  ...
  object edPCT_GTIA_LIQ: TInterEdit
    ...
    Width = 80
    Height = 21
    Hint = 'Porcentaje de Garantía Líquida aplicada'
    HelpContext = 2000
    Prefijo = '1'
    Contrato = -1
    TipoReader = trDinero
  ...
  object edPCT_CUOTA_FEGA: TInterEdit
    Tag = 18
    Left = 470
    Top = 73
    Width = 80
