object WCrImpDirProd: TWCrImpDirProd
  Left = 292
  Top = 430
  Width = 573
  Height = 234
  Caption = 'Catálogo de Relación Dirección - Producto'
  Color = clBtnFace
  ...
  object rgSIT_REL_DIR_PROD: TRadioGroup
    Tag = 18
    Left = 0
    Top = 68
    Width = 565
    Height = 32
    HelpContext = 4001
    Caption = 'Situación de la Relación Dirección -  Producto'
    Columns = 2
    ItemIndex = 0
    Items.Strings = (
      'Activo'
  ...
  object btDIRECCION: TBitBtn
    ...
    HelpContext = 2002
    TabOrder = 1
    OnClick = btDIRECCIONClick
    OnExit = btDIRECCIONExit
    Glyph.Data = {
      36060000424D3606000000000000360400002800000020000000100000000100
      0800000000000002000000000000000000000001000000010000000000008080
      8000000080000080800000800000808000008000000080008000408080004040
  ...
  object ilDIRECCION: TInterLinkit
    Control = edCVE_DIRECCION
    OnEjecuta = ilDIRECCIONEjecuta
    TipoReader = trTexto
    CharCase = ecUpperCase
    OnCapture = ilDIRECCIONCapture
    Left = 232
    Top = 6
  end
end
