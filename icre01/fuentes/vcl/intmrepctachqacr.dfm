object WMRepChqAc: TWMRepChqAc
  Left = 327
  Top = 208
  Width = 545
  Height = 282
  Caption = 'Reporte de Cuentas de Cheques Asociadas al Acreditado'
  Color = clBtnFace
  ...
  object chbAcreditado: TCheckBox
    Left = 499
    Top = 76
    Width = 14
    Height = 17
    ...
    Enabled = False
    TabOrder = 7
    OnClick = chbAcreditadoClick
  end
  object chbCtaCheques: TCheckBox
    Left = 499
    Top = 134
    Width = 14
    Height = 17
