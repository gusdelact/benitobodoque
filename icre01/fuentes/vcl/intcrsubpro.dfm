object WCrSubdivProcam: TWCrSubdivProcam
  Left = 393
  Top = 86
  Width = 539
  Height = 264
  Caption = 'Catálogo de Sub-divisiones de PROCAMPO'
  Color = clBtnFace
  ...
  object lbNOMBRE_SUB_DIV: TLabel
    Left = 8
    Top = 82
    Width = 54
    Height = 13
  ...
  object lbSIT_SUBDIVISION: TLabel
    Left = 8
    Top = 106
    Width = 101
    Height = 13
    Caption = 'Situación Subdivision'
    Visible = False
  end
  ...
  object edNOMBRE_SUB_DIV: TEdit
    ...
    MaxLength = 100
    TabOrder = 3
    OnExit = edNOMBRE_SUB_DIVExit
  end
  object rgSIT_SUBDIVISION: TRadioGroup
    Tag = 18
    Left = 8
    Top = 106
    Width = 521
