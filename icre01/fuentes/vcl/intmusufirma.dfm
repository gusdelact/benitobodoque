object WMUsuFirma: TWMUsuFirma
  Left = 221
  Top = 188
  Width = 519
  Height = 239
  Caption = 'Catálogo de Usuarios por grupo de Firmas'
  Color = clBtnFace
  ...
  object rgSIT_USU_FIRMA: TRadioGroup
    Tag = 18
    Left = 0
    Top = 81
    Width = 510
    ...
    Items.Strings = (
      ...
      'Inactivo')
    TabOrder = 7
    OnExit = rgSIT_USU_FIRMAExit
  end
  object btFIRMA: TBitBtn
    Tag = 50
    Left = 187
    Top = 8
    Width = 21
  ...
  object rgCVE_TIPO_ROL: TRadioGroup
    Tag = 18
    Left = 0
    Top = 50
    Width = 510
    Height = 32
    HelpContext = 3000
    Caption = 'Posición que desempeña'
    Columns = 2
    Enabled = False
    ItemIndex = 0
    Items.Strings = (
  ...
  object ilFIRMA: TInterLinkit
    Control = edCVE_FIRMA
    OnEjecuta = ilFIRMAEjecuta
    TipoReader = trTexto
    CharCase = ecUpperCase
    OnCapture = ilFIRMACapture
    Left = 292
    Top = 4
  end
