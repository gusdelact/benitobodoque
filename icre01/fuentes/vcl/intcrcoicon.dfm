object WCrCoincreConc: TWCrCoincreConc
  Left = 161
  Top = 527
  Width = 630
  Height = 155
  Caption = 'Relación Producto Cuentas Contables'
  Color = clBtnFace
  ...
  object lbCVE_CTA_CONTABLE: TLabel
    Left = 8
    Top = 74
    Width = 106
    Height = 13
    Caption = 'Clave de Cta Contable'
  end
  object lbSIT_RELACION: TLabel
    Left = 360
    Top = 74
    Width = 65
    Height = 13
  ...
  object edCVE_CTA_CONTABLE: TEdit
    Tag = 50
    Left = 136
    Top = 70
    Width = 185
  ...
  object cbSistemaCredito: TComboBox
    Left = 536
    Top = 9
    Width = 81
    Height = 21
