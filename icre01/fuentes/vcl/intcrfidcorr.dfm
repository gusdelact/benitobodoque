object WCrFidCorreo: TWCrFidCorreo
  Left = 292
  Top = 184
  Width = 663
  Height = 246
  Caption = 'Destinatarios de Avisos FIDEICOMISOS'
  Color = clBtnFace
  ...
  object rgSIT_FID_CORREO: TRadioGroup
    Tag = 18
    Left = 416
    Top = 102
    Width = 234
    Height = 50
    HelpContext = 1300
    Caption = 'Sit. de Destinatario de Avisos'
    Columns = 2
    Enabled = False
    ItemIndex = 0
    Items.Strings = (
