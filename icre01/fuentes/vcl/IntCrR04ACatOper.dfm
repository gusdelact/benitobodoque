object wCRR4CATOP: TwCRR4CATOP
  Left = 388
  Top = 239
  Width = 423
  Height = 210
  Caption = 'Catálogo de Claves de Operación para R04A'
  Color = clBtnFace
  ...
  object btnCveOperacion: TBitBtn
    Tag = 17
    Left = 161
    Top = 55
    Width = 21
  ...
  object edtDescCveOperacion: TEdit
    Left = 183
    Top = 54
    Width = 175
    Height = 21
  ...
  object dbCboReporte: TDBLookupComboBox
    Tag = 50
    Left = 72
    Top = 24
    Width = 289
  ...
  object cdsReporte: TClientDataSet
    ...
    Left = 304
    Top = 104
    object cdsReporteTIPO_REPORTE: TIntegerField
      FieldName = 'TIPO_REPORTE'
    end
    object cdsReporteDESCRIPCION_REPORTE: TStringField
      DisplayWidth = 100
