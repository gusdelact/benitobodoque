object WCrEmisorDoc: TWCrEmisorDoc
  Left = 479
  Top = 190
  Width = 601
  Height = 329
  Caption = 'Documentos por Emisor'
  Color = clBtnFace
  ...
  object rgSIT_DOCUMENTO: TRadioGroup
    ...
    Height = 37
    HelpContext = 1400
    Caption = 'Situación Documento por Emisor'
    Columns = 2
    ItemIndex = 0
    Items.Strings = (
      'Activo'
  ...
  object chB_FV_REAL: TCheckBox
    ...
    Caption = 'Opera Fecha de Vencimiento Real'
    TabOrder = 11
    OnExit = chB_FV_REALExit
  end
  ...
  object ilTIPO_DOCTO: TInterLinkit
    Control = edCVE_DOCUMENTO
    OnEjecuta = ilTIPO_DOCTOEjecuta
    TipoReader = trTexto
    CharCase = ecUpperCase
    OnCapture = ilTIPO_DOCTOCapture
    Left = 248
    Top = 70
  end
