object wMPerito: TwMPerito
  Left = 247
  Top = 159
  Width = 515
  Height = 250
  Caption = 'Catálogo de Peritos'
  Color = clBtnFace
  ...
  object edDESC_INSTITUCION: TEdit
    Tag = 18
    Left = 94
    Top = 47
    Width = 411
    Height = 21
    Hint = 'Institución que otorga el registro'
    HelpContext = 2100
    CharCase = ecUpperCase
    MaxLength = 60
    ParentShowHint = False
