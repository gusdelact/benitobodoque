object WCrTasaGrupo: TWCrTasaGrupo
  Left = 364
  Top = 216
  Width = 543
  Height = 337
  Caption = 'Configuración de la Tasa Base'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object lbCVE_TASA_INDICAD: TLabel
    Left = 12
    Top = 11
    Width = 24
    Height = 13
  ...
  object rgCVE_OPERACION: TRadioGroup
    ...
    Width = 529
    Height = 32
    Caption = 'Operación para determinar el valor de la tasa'
    Columns = 3
    Items.Strings = (
      'Menor'
      'Mayor'
  ...
  object btnCVE_TASA_INDIC: TBitBtn
    Tag = 50
    Left = 160
    Top = 6
    Width = 22
    ...
    HelpContext = 3002
    TabOrder = 1
    OnClick = btnCVE_TASA_INDICClick
    Glyph.Data = {
  ...
  object stpCalcTasaRefer: TStoredProc
    DatabaseName = 'DCORP'
