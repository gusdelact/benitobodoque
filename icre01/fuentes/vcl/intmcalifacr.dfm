object WMCalifAcr: TWMCalifAcr
  Left = 314
  Top = 243
  Width = 556
  Height = 317
  Caption = 'Reporte de Calificación por Acreditado'
  Color = clBtnFace
  ...
  object GroupBox2: TGroupBox
    ...
    object cbMUESTRA: TCheckBox
      ...
      Caption = 
        'Mostar únicamente los acreditados calificados por las agencias c' +
        'alificadoras'
      Checked = True
    ...
    object edNOM_ID_CALIFICADORA: TEdit
      Left = 222
      Top = 32
      Width = 258
      Height = 21
    ...
    object chbID_CALIFICADORA: TCheckBox
      Left = 499
      Top = 34
      Width = 14
      Height = 17
      ...
      Enabled = False
      TabOrder = 7
      OnClick = chbID_CALIFICADORAClick
    end
  end
