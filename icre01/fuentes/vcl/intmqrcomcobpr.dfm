object QrComCobPr: TQrComCobPr
  ...
  object QRFooterProducto: TQRBand
    ...
    object QRExpr6: TQRExpr
      ...
      Transparent = True
      WordWrap = True
      Expression = 'SUM(qyComCobPr.IMP_CREDITO)'
      Mask = '###,###,###,###,###,##0.00'
      FontSize = 5
    end
    object QRExpr3: TQRExpr
      ...
      Transparent = True
      WordWrap = True
      Expression = 'SUM(qyComCobPr.IMP_IVA)'
      Mask = '###,###,###,###,###,##0.00'
      FontSize = 5
    end
    object QRExpr4: TQRExpr
      ...
      Transparent = True
      WordWrap = True
      Expression = 'SUM(qyComCobPr.IMP_COMISION)'
      Mask = '###,###,###,###,###,##0.00'
      FontSize = 5
    end
  end
  ...
  object qrgrpFooterPromAdm: TQRBand
    Left = 48
    Top = 250
    Width = 720
    Height = 11
  ...
  object QRGroupTipoOper: TQRGroup
    ...
    Size.Values = (
      37.0416666666667
      1905)
    Expression = 'qyRelBlqDs.TIP_TRN'
    FooterBand = qrgrpFooterPromAsoc
    Master = Owner
    ReprintOnNewPage = False
  ...
  object qrgrpFooterPromAsoc: TQRBand
    Left = 48
    Top = 261
    Width = 720
    Height = 11
  ...
  object qyComCobPr: TQuery
    Left = 82
    Top = 12
    object qyComCobPrF_AUTORIZA: TDateTimeField
      FieldName = 'F_AUTORIZA'
    end
    object qyComCobPrDESC_MONEDA: TStringField
      FieldName = 'DESC_MONEDA'
    end
    object qyComCobPrNOMBRE: TStringField
      FieldName = 'NOMBRE'
      Size = 80
    end
    object qyComCobPrID_CREDITO: TFloatField
      FieldName = 'ID_CREDITO'
    end
    object qyComCobPrCVE_MONEDA: TFloatField
      FieldName = 'CVE_MONEDA'
    end
    object qyComCobPrID_TITULAR: TFloatField
      FieldName = 'ID_TITULAR'
    end
    object qyComCobPrIMP_CREDITO: TFloatField
      FieldName = 'IMP_CREDITO'
    end
    object qyComCobPrCVE_COMISION: TStringField
      FieldName = 'CVE_COMISION'
      Size = 6
    end
    object qyComCobPrDESC_COMISION: TStringField
      FieldName = 'DESC_COMISION'
      Size = 80
    end
    object qyComCobPrIMP_COMISION: TFloatField
      FieldName = 'IMP_COMISION'
    end
    object qyComCobPrIMP_IVA: TFloatField
      FieldName = 'IMP_IVA'
    end
    object qyComCobPrID_PERS_ASOCIAD: TFloatField
      FieldName = 'ID_PERS_ASOCIAD'
    end
    object qyComCobPrNOM_PROM_ASOC: TStringField
      FieldName = 'NOM_PROM_ASOC'
      Size = 80
    end
    object qyComCobPrID_PROM_ADM: TFloatField
      FieldName = 'ID_PROM_ADM'
    end
    object qyComCobPrNOM_PROM_ADM: TStringField
      FieldName = 'NOM_PROM_ADM'
      Size = 80
    end
    object qyComCobPrCVE_PRODUCTO_CRE: TStringField
      FieldName = 'CVE_PRODUCTO_CRE'
      Size = 6
    end
    object qyComCobPrDESC_L_PRODUCTO: TStringField
      FieldName = 'DESC_L_PRODUCTO'
      Size = 80
    end
    object qyComCobPrCVE_PRODUCTO_GPO: TStringField
      FieldName = 'CVE_PRODUCTO_GPO'
      Size = 6
    end
    object qyComCobPrSIT_COMISION: TStringField
      FieldName = 'SIT_COMISION'
      Size = 2
    end
    object qyComCobPrNUM_PERIODO: TFloatField
      FieldName = 'NUM_PERIODO'
    end
    object qyComCobPrTOT_COM: TFloatField
      FieldName = 'TOT_COM'
    end
    object qyComCobPrID_EMPRESA: TFloatField
