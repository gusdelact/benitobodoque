object QrAvCesion: TQrAvCesion
  ...
  object qyAvCesion: TQuery
    ...
    Left = 236
    Top = 32
    object qyAvCesionID_CESION: TFloatField
      FieldName = 'ID_CESION'
    end
    object qyAvCesionNOM_EMISOR: TStringField
      FieldName = 'NOM_EMISOR'
      Size = 80
    end
    object qyAvCesionNOM_PROVEEDOR: TStringField
      FieldName = 'NOM_PROVEEDOR'
      Size = 80
    end
    object qyAvCesionRFC_E: TStringField
      FieldName = 'RFC_E'
      Size = 14
    end
    object qyAvCesionRFC_P: TStringField
      FieldName = 'RFC_P'
      Size = 14
    end
    object qyAvCesionDIRECCION_E: TStringField
      FieldName = 'DIRECCION_E'
      Size = 60
    end
    object qyAvCesionCOLONIA_E: TStringField
      FieldName = 'COLONIA_E'
      Size = 40
    end
    object qyAvCesionDELEGACION_E: TStringField
      FieldName = 'DELEGACION_E'
      Size = 40
    end
    object qyAvCesionCODIGO_POSTAL_E: TStringField
      FieldName = 'CODIGO_POSTAL_E'
      Size = 6
    end
    object qyAvCesionCIUDAD_E: TStringField
      FieldName = 'CIUDAD_E'
      Size = 40
    end
    object qyAvCesionDIRECCION_P: TStringField
      FieldName = 'DIRECCION_P'
      Size = 60
    end
    object qyAvCesionCOLONIA_P: TStringField
      FieldName = 'COLONIA_P'
      Size = 40
    end
    object qyAvCesionDELEGACION_P: TStringField
      FieldName = 'DELEGACION_P'
      Size = 40
    end
    object qyAvCesionCODIGO_POSTAL_P: TStringField
      FieldName = 'CODIGO_POSTAL_P'
      Size = 6
    end
    object qyAvCesionCIUDAD_P: TStringField
      FieldName = 'CIUDAD_P'
      Size = 40
    end
    object qyAvCesionDESC_L_PRODUCTO: TStringField
      FieldName = 'DESC_L_PRODUCTO'
      Size = 80
    end
    object qyAvCesionCTA_EMI: TStringField
      FieldName = 'CTA_EMI'
      FixedChar = True
      Size = 4
    end
    object qyAvCesionCTA_PROV: TStringField
      FieldName = 'CTA_PROV'
      FixedChar = True
      Size = 4
    end
    object qyAvCesionDESC_MONEDA: TStringField
      FieldName = 'DESC_MONEDA'
    end
    object qyAvCesionIMP_CAPITAL: TFloatField
      FieldName = 'IMP_CAPITAL'
    end
    object qyAvCesionIMP_INTERES: TFloatField
      FieldName = 'IMP_INTERES'
    end
    object qyAvCesionIMP_IVA: TFloatField
      FieldName = 'IMP_IVA'
    end
    object qyAvCesionIMP_TOTAL_INT: TFloatField
      FieldName = 'IMP_TOTAL_INT'
    end
    object qyAvCesionAVISO: TStringField
      FieldName = 'AVISO'
      FixedChar = True
      Size = 5
    end
    object qyAvCesionF_ALTA: TDateTimeField
      FieldName = 'F_ALTA'
    end
    object qyAvCesionCERO: TFloatField
      FieldName = 'CERO'
    end
    object qyAvCesionCONCEPTO: TFloatField
      FieldName = 'CONCEPTO'
    end
    object qyAvCesionIVA: TFloatField
      FieldName = 'IVA'
    end
    object qyAvCesionIMPORTE_TOT: TFloatField
      FieldName = 'IMPORTE_TOT'
    end
    object qyAvCesionF_AUTORIZA: TDateTimeField
      FieldName = 'F_AUTORIZA'
    end
    object qyAvCesionB_APLICA_IVA: TStringField
      FieldName = 'B_APLICA_IVA'
      Size = 1
    end
    object qyAvCesionCVE_PER_JURIDICA: TStringField
      FieldName = 'CVE_PER_JURIDICA'
      Size = 2
    end
    object qyAvCesionPCT_IVA: TFloatField
      FieldName = 'PCT_IVA'
    end
  end
end
