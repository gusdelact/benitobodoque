...
// Función forma   : Clase de CRRESCALIF
...
begin
  ...
  try
    ...
    XLSheet.Cells [3, 2].Formula := 'Información expresada en Pesos';
    ...
    XLSheet.Cells [6,  1].Formula := 'Clasificación';
    ...
    XLSheet.Cells [6,  4].Formula := 'Clave Calificación';
    XLSheet.Range ['B5:B6'].Merge;
    ...
    XLSheet.Cells [6,  9].Formula := 'ID Crédito';
    XLSheet.Range ['G5:G6'].Merge;
    XLSheet.Cells [6, 10].Formula := 'Tipo Crédito';
