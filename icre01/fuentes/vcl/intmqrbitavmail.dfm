object QrBitAvMail: TQrBitAvMail
  Left = 0
  Top = 0
  Width = 1056
  Height = 816
  ...
  object QRGroupMoneda: TQRGroup
    ...
    Size.Values = (
      42.3333333333333
      2540)
    Expression = 'qyBitAvMail.F_AVISO_OPER'
    Master = Owner
  ...
  object QRGroup1: TQRGroup
    ...
    Size.Values = (
      42.3333333333333
      2540)
    Expression = 'qyBitAvMail.CVE_AVISO'
    Master = Owner
    ReprintOnNewPage = False
  ...
  object qyBitAvMail: TQuery
    Left = 82
    Top = 12
    object qyBitAvMailID_CREDITO: TFloatField
      FieldName = 'ID_CREDITO'
    end
    object qyBitAvMailID_DOCUMENTO: TStringField
      FieldName = 'ID_DOCUMENTO'
    end
    object qyBitAvMailF_AVISO: TDateTimeField
      FieldName = 'F_AVISO'
    end
    object qyBitAvMailFH_ENVIO_MAIL: TDateTimeField
      FieldName = 'FH_ENVIO_MAIL'
    end
    object qyBitAvMailCVE_AVISO: TStringField
      FieldName = 'CVE_AVISO'
      Size = 6
    end
    object qyBitAvMailNUM_IMPRESION: TFloatField
      FieldName = 'NUM_IMPRESION'
    end
    object qyBitAvMailB_MAIL: TStringField
      FieldName = 'B_MAIL'
      Size = 1
    end
    object qyBitAvMailTX_MAIL: TStringField
      FieldName = 'TX_MAIL'
      Size = 250
    end
    object qyBitAvMailCVE_USUARIO: TStringField
      FieldName = 'CVE_USUARIO'
      Size = 8
    end
    object qyBitAvMailDESC_AVISO: TStringField
      FieldName = 'DESC_AVISO'
      Size = 80
    end
    object qyBitAvMailF_AVISO_OPER: TDateTimeField
      FieldName = 'F_AVISO_OPER'
    end
    object qyBitAvMailNOM_PROVEEDOR: TStringField
      FieldName = 'NOM_PROVEEDOR'
      Size = 80
    end
    object qyBitAvMailIMP_OPERACION: TFloatField
