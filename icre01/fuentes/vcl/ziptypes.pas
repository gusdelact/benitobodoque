...
Type definitions for UNZIP
  ...
  * extended
    and
    amended for Win32 and OS/2 (Virtual Pascal) by Dr Abimbola Olowofoyeku (The African Chief)
  * amended for FreePascal by Peter Vreman
  * ConvertPath and CalcRatio routines by Peter Vreman
  * amended for GNU Pascal (GPC) by Dr Abimbola Olowofoyeku (The African Chief)
...
USES GPC;
TYPE
  Longint = Integer  ( 32 );  { GPC's normal Longint is 64-bit }
  Word    = Cardinal ( 16 );  { GPC's normal Word is 32-bit }
  Word16  = Cardinal ( 16 );
  Word32  = Cardinal ( 32 );
  Word64  = Cardinal ( 64 );
  Int64   = Integer  ( 64 );
...
{$else}
TYPE
  Word64  = {$ifdef ver120}Int64{$else}Longint{$endif};
  Int64   = {$ifdef ver120}Int64{$else}Longint{$endif};
  Word32  = {$ifdef ver120}Cardinal{$else}Longint{$endif};
  Int32   = Longint;
  Word16  = Word;
{$endif}
...
{ Record for UNZIP }
TYPE BufType  = ARRAY [ 0..TFileBufferSize ] OF char;
TYPE TDirType = ARRAY [ 0..TFileNameSize ] OF char;
