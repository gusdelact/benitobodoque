...
type
	TRepIlineConvenio = class(TQuickRep)
		QRBand1: TQRBand;
		QRBand2: TQRBand;
    ...
    procedure RepIlineConvenioBeforePrint(Sender: TCustomQuickRep;
...
var
  qrConvenio : TRepIlineConvenio;
  Base       : Real;
  NomTit     : String;  

Procedure Execute_RepILineConvenio(Padre: TInterFrame; Contrato_Asoc: Real; Titular : String; NombreAutoriza : String; Preview: Boolean);
...
Procedure Execute_RepILineConvenio(Padre: TInterFrame; Contrato_Asoc: Real ; Titular : String; NombreAutoriza : String; Preview: Boolean);
Var Rep: TRepILineConvenio;
begin
	Rep:= TRepILineConvenio.Create(nil);
	Try
...
procedure TRepIlineConvenio.RepIlineConvenioBeforePrint(
