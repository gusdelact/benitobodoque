...
// Fecha de Inicio : 18/12/2011
// Función forma   : Clase de DV_TRANSACCION
// Desarrollo por  : MACV. Class Maker.
// Diseñado por    : Nzirzvhgsvozzonzmazxznzirool
// Comentarios     :
Unit IntDvTransac;
...
constructor TDvTransac.Create( AOwner : TComponent ); 
begin Inherited; 
      ...
      TableName := 'DV_TRANSACCION'; 
      UseQuery := True; 
      HelpFile := 'IntDvTransac.Hlp';
...
function TDvTransac.ShowWindow(FormaTipo:TFormaTipo):Integer;
var W : TWDvTransaccion;
begin
   W:=TWDvTransaccion.Create(Self);
   try
      W.Objeto:= Self;
...
Function TDvTransac.InternalBusca:Boolean;
Var T:TInterFindit;
...
function TDvTransac.Reporte:Boolean; 
...
procedure TWDvTransaccion.FormShow(Sender: TObject);
begin
...
procedure TWDvTransaccion.FormDestroy(Sender: TObject);
begin
...
procedure TWDvTransaccion.FormClose(Sender: TObject; var Action: TCloseAction);
begin Action := caFree;
end;

procedure TWDvTransaccion.InterForma1DespuesNuevo(Sender: TObject);
begin //<<Control>>.SetFocus;
end;

procedure TWDvTransaccion.InterForma1DespuesModificar(Sender: TObject);
begin //<<Control>>.SetFocus;
end;

//procedure TWDvTransaccion.BitBtn1Click(Sender: TObject); 
//begin // Objeto.Reporte; 
//end;


procedure TWDvTransaccion.Button1Click(Sender: TObject);
...
function TWDvTransaccion.fUsrInfDpVista: Boolean;
Var
  Q : TQuery;
begin
  Q := TQuery.Create(nil);
