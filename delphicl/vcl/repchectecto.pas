...
type
  TReporteChCteCto = class(TQuickRep)
    DetailBand1: TQRBand;
...
Procedure Execute_RepChCteCto(ShowPreview:Boolean; Padre:TInterFrame; Id_Contrato:Integer);

implementation

{$R *.DFM}
Procedure Execute_RepChCteCto(ShowPreview:Boolean; Padre:TInterFrame; Id_Contrato:Integer);
var Reporte: TReporteChCteCto;
begin Reporte:=TReporteChCteCto.Create(Padre);
      Try
