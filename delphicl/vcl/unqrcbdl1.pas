...
PROCEDURE execute_conf_BDlsCall(pPreview : Boolean;pApli : TInterApli; pIdContrato : Double; pIdPagare:Double;
                                pAtencion : String);
...
PROCEDURE execute_conf_BDlsCall(pPreview : Boolean;pApli : TInterApli; pIdContrato : Double; pIdPagare:Double;
                                pAtencion : String);
Var   QRCBDL1 : TQRCBDL1;
begin QRCBDL1:= TQRCBDL1.Create(Nil);
      try QRCBDL1.qPagares.DatabaseName:=pApli.DataBaseName;
          QRCBDL1.qPagares.SessionName :=pApli.SessionName;
          QRCBDL1.qPagares.ParamByName('Cto').AsFloat:=pIdContrato;
          QRCBDL1.qPagares.ParamByName('Pag').AsFloat:=pIdPagare;
          QRCBDL1.qPagares.Open;
          QRCBDL1.qrlAtencion.Caption:=pAtencion;
          if pPreview
          then QRCBDL1.Preview
          else QRCBDL1.Print;
      finally
       QRCBDL1.qPagares.Close;
       QRCBDL1.free;
      end;
end;

procedure TQRCBDL1.qPagaresCalcFields(DataSet: TDataSet);
